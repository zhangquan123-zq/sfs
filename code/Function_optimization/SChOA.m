%% 加入Sobol序列初始化的黑猩猩算法(SChOA)
function [Attacker_score, Attacker_pos, Convergence_curve] = SChOA(X, N, Max_iter, lb, ub, dim, fobj)
...
while l < Max_iter
    ...
    disp(['SChOA: At iteration ', num2str(l), ' ,the best fitness is ', num2str(Convergence_curve(l))]);
end
